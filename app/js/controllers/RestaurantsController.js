'use strict';
(function () {
    appetiteApp.controller('RestaurantsController', RestaurantsController);

    RestaurantsController.$inject = ['$scope', 'customer', '$location', 'Restaurant'];
    ...
    function RestaurantsController($scope, customer, $location, Restaurant) {
        ...
        var allRestaurants = [];
        Restaurant.RestaurantList(0).then(function (restaurants) {
